...
from jaxlayerlumos import jaxlayerlumos_old


def compute_properties_jaxlayerlumos_old(thicknesses, n_k, frequencies, angle_of_incidence):
    ...
    R_TE, T_TE, R_TM, T_TM = jaxlayerlumos_old.stackrt(
