...
def test_get_eps_mu_Michielssen():
    ...
    with pytest.raises(AssertionError):
        utils_radar_materials.get_eps_mu_Michielssen(onp.array([5, 2, 3, 0]), frequencies)
    with pytest.raises(AssertionError):
        utils_radar_materials.get_eps_mu_Michielssen(onp.array([18, 20, 17, 5, 2, 3, 0, -1]), frequencies)
    with pytest.raises(AssertionError):
        utils_radar_materials.get_eps_mu_Michielssen(onp.array([16, 5, 2, 3, 0, -1]), frequencies)
    with pytest.raises(AssertionError):
    ...
    eps, mu = utils_radar_materials.get_eps_mu_Michielssen(material_indices, frequencies)
