...
class TestJaxLayerLumosStackrt(unittest.TestCase):
    ...
    def test_angles(self):
        ...
        expected_R_avg = jnp.array(
            [
                [0.5075084159634257, 0.18726655434023687, 0.08370762967721315,],
                [0.4877839691834523, 0.1945178061281731, 0.09157449689223793,],
                [0.9498492283810344, 0.9783936773043997, 0.9540558921256859,],
            ]
        )

        expected_T_avg = jnp.array(
            [
                [0.17839133609006402, 0.8127334404810548, 0.916292370322787,],
                [0.18801137946236623, 0.8054821885944445, 0.9084255031077624,],
                [0.006495561010086865, 0.021606322148813736, 0.04594410787425793,],
            ]
        )
